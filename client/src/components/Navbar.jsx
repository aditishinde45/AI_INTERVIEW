...
function Navbar() {
    ...
    const handleLogout=async()=>{
        try{
            await axios.get(ServeUrl+"/api/auth/logout",{withCredentials:true});
            ...
            <div className='relative'>
                ...
                {showCreditPopup && (
                    <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50'>
                        <p className='text-sm text-gray-600 mb-4'>Need more credits to continue more interviews ?</p>
