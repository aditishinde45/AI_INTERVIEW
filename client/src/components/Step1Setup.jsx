...
function Step1Setup({ onStart }) {
  ...
  const [analysisDone,isAnalysisDone]=useState(false);
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-4xl min-h-[340px] bg-white rounded-2xl shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-2"
      >
           ...
           className="w-full py-3 px-4 border border-gray-200 rounded-xl
              ...
              rounded-xl p-8 text-center cursor-pointer hover:border-green-500 hover:bg-green-50 transition">
                ...
                <p className="text-gray-600 font-medium">
                  {resumeFile ? resumeFile.name:"click to upload resume (optinal)"}
                </p>
            ...
            {analysisDone && (
              ...
              className="bg-gray-50 border border-gray-200 rounded-xl p-5 space-y-4">
                ...
                {projects.length>0 && (
                    <div>
                       <p className="font-medium text-gray-700 mg-1">
                      Projects:
                    </p>
