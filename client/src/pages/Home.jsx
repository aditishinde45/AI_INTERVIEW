            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc:"Detailed Strengths, weaknesses and improvements insights"
                  },
                  {
                    image:history,
                    icon:<BsBarChart size={20}/>,
                    title:"History & Analytics",
                    desc:"Track progress with performance graphs & topic analysis"
                  }
                ].map((item, index) => {
  return (
    <motion.div
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-6">
        <div className='w-1/2'>
        <h3 className='font-semibold text-xl mg-3'>
          {mode.title}
        </h3>
        ...
        <img src={mode.img} alt={mode.title}  className='w-28 h-28 object-contains'/>
        </div>
      </div>
    </motion.div>
  );
